/**
 * Shared Himalaya CLI Wrapper
 *
 * Low-level wrapper around the himalaya binary.
 * Runs commands with JSON output and parses results.
 *
 * Usage:
 *   const { runHimalaya } = require('../shared/himalaya-cli');
 *   const result = await runHimalaya(['envelope', 'list', '--account', 'vq']);
 */
