...
| `0 12 * * 1` | **LAM 3PL** | Weekly Mon 12:00 — runs LAM 3PL reorder analysis (BOM → demand → franchise sourcing → RFQ writes → customer offer refresh) | `Trading Analysis/LAM 3PL/lam-kitting-runner.js` | `Trading Analysis/LAM 3PL/data/cron.log` |
