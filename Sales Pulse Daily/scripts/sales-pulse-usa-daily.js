  ...
  if (data.repActivity.length > 0) {
    ...
    data.repActivity.forEach(rep => {
      html += `
        <tr>
          ...
          <td style="text-align: center;">${formatNumber(rep.rfq_lines)}</td>
          <td style="text-align: center;">${formatNumber(rep.cq_lines)}</td>
          <td style="text-align: center;">${formatNumber(rep.cq_sold)}</td>
          <td style="text-align: center;">${formatNumber(rep.so_lines)}</td>
          <td class="number">${formatCurrency(rep.so_revenue)}</td>
          <td class="number">${formatCurrency(rep.so_gp)}</td>
        </tr>`;
    });
    ...
    html += `
      <tr style="border-top: 2px solid #333; background-color: #f5f5f5; font-weight: bold;">
        ...
        <td style="text-align: center;">${formatNumber(data.repTotals.rfq_lines)}</td>
        <td style="text-align: center;">${formatNumber(data.repTotals.cq_lines)}</td>
        <td style="text-align: center;">${formatNumber(data.repTotals.cq_sold)}</td>
        <td style="text-align: center;">${formatNumber(data.repTotals.so_lines)}</td>
        <td class="number"><strong>${formatCurrency(data.repTotals.so_revenue)}</strong></td>
        <td class="number"><strong>${formatCurrency(data.repTotals.so_gp)}</strong></td>
      </tr>`;
